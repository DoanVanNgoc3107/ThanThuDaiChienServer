...
# 深渊无限塔 假的活动ID 用于存放布阵阵容
AbyssEndlessTowerHuodongID = -7
...
# [拟态对战] 排行榜奖励邮件 CSV ID
MimicryRankAwardMailID = 98

# [卡牌冒险] 跨服排行榜奖励邮件 CSV ID（总榜和训练家分榜共用）
AutoChessRankAwardMailID = 99
...
# 世界锦标赛全服排行奖励邮件 CSV ID
CrossSupremacyRankAwardMailID = 90

# 世界锦标赛战区排行奖励邮件 CSV ID
CrossSupremacyDivisionRankAwardMailID = 91

# 世界锦标赛未领取资源奖励邮件 CSV ID
CrossSupremacyResAwardMailID = 92

# 世界锦标赛段位奖励邮件 CSV ID
CrossSupremacyGradeAwardMailID = 93
