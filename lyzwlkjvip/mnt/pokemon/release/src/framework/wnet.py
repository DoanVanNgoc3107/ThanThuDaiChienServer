...
def _lz4_compress(data):
	if hasattr(lz4, 'compress'):
		return lz4.compress(data)
	if lz4_block is not None and hasattr(lz4_block, 'compress'):
		return lz4_block.compress(data)
	return zlib.compress(data)


def _lz4_uncompress(data):
	if hasattr(lz4, 'uncompress'):
		return lz4.uncompress(data)
	if hasattr(lz4, 'decompress'):
		return lz4.decompress(data)
	if lz4_block is not None and hasattr(lz4_block, 'decompress'):
