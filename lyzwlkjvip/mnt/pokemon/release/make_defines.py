...
def genStorageTemplate(key):
	...
	if lang == 'cn' or lang == 'cn_qd':
		...
		# mongodb = "mongodb://gamesystem:kdgame#17216210@172.16.2.10:27017/%s?authMechanism=SCRAM-SHA-1&authSource=admin"% dbname
		mongodb = "mongodb://gamesystem:kdgame#17216228@172.16.2.28:27017/%s?authMechanism=SCRAM-SHA-1&authSource=admin"% dbname
