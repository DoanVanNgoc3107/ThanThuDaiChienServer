-- chunkname: @cocos.cocos2d.DeprecatedCocos2dFunc
...
function TextureCacheDeprecated:getInstance()
...
function CCAnimationDeprecated:addSpriteFrameWithFileName(...)
...
function CCNodeDeprecated:boundingBox()
...
function CCProgressTimerDeprecated:setReverseProgress(...)
...
function CCSpriteFrameCacheDeprecated:spriteFrameByName(szName)
...
function CCLabelAtlasDeprecated:create(...)
...
function CCGrid3DActionDeprecated:vertex(pt)
...
function CCTiledGrid3DActionDeprecated:tile(pt)
...
function CCTexture2DDeprecated:stringForFormat()
...
function CCMenuItemToggleDeprecated:selectedItem()
...
function CCTileMapAtlasDeprecated:tileAt(pos)
...
function CCTMXLayerDeprecated:tileAt(tileCoordinate)
...
function CCTMXTiledMapDeprecated:layerNamed(layerName)
...
function CCTMXMapInfoDeprecated:getStoringCharacters()
...
function CCTMXObjectGroupDeprecated:propertyNamed(propertyName)
...
function CCRenderTextureDeprecated:newCCImage()
...
function CCSpriteDeprecated:setFlipX(flag)
...
function CCLayerDeprecated:setKeypadEnabled(enabled)
...
function NodeDeprecated:setZOrder(zOrder)
...
function GLProgram:initWithVertexShaderByteArray(vShaderByteArray, fShaderByteArray)
