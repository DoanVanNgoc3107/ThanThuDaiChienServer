-- chunkname: @cocos.cocostudio.CocoStudio
	...
	if cons ~= nil then
		...
		for i = 1, count do
			...
			if className ~= nil then
				...
				assert(obj ~= nil, string.format("class named %s can not implement!", className))
	...
	if actions ~= nil then
		...
		for i = 1, count do
			...
			if className ~= nil then
				...
				assert(act ~= nil, string.format("class named %s can not implement!", className))
