...
battleModule.mods = {
	...
	require("battle.app_views.battle.module.aid"),
	require("battle.app_views.battle.module.team"),
	require("battle.app_views.battle.module.extraround_merge"),
...
battleModule.mimicryMods = {
	require("battle.app_views.battle.module.spec.mimicry")
}
battleModule.crossCircusMods = {
	require("battle.app_views.battle.module.spec.cross_circus")
}
