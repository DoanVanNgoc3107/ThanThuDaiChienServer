-- chunkname: @src.app.views.city.adventure.gym_challenge.npc_info
...
function GymNpcInfoView:onCreate(id)
	...
	self.item = ccui.Layout:create():size(180, 180):show():setTouchEnabled(true):retain():scale(0.8)
	...
	self.monsterDatas = arraytools.merge({
		bossDatas,
		monsterDatas
	})
