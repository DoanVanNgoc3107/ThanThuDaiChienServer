-- chunkname: @src.battle.models.extra_record
...
local function check_true()
	return true
end

local function check_false()
	return false
end
...
local EventTypeMap = {
	[battle.ExRecordEvent.lockHpTotalDamage] = EventFuncMap.set,
	...
	[battle.ExRecordEvent.attackState] = EventFuncMap.set,
	[battle.ExRecordEvent.fieldBuffRelation] = EventFuncMap.set,
	[battle.ExRecordEvent.barrierLockTurn] = EventFuncMap.set,
	[battle.ExRecordEvent.buffFreezeFlag] = EventFuncMap.set,
	[battle.ExRecordEvent.roundAttackInfo] = EventFuncMap.set,
	[battle.ExRecordEvent.customRecord] = EventFuncMap.set,
	[battle.ExRecordEvent.attackedRoundRecord] = EventFuncMap.set,
	[battle.ExRecordEvent.extraAttackDataInFastReborn] = EventFuncMap.set,
	[battle.ExRecordEvent.copyOrTransferBuff] = EventFuncMap.insert,
	[battle.ExRecordEvent.skillEffectLimit] = EventFuncMap.insert,
	[battle.ExRecordEvent.commandeerAll] = EventFuncMap.insert,
	[battle.ExRecordEvent.commandeerCaster] = EventFuncMap.insert,
	[battle.ExRecordEvent.weatherLevels] = EventFuncMap.insert,
	[battle.ExRecordEvent.backStageRoundInfo] = EventFuncMap.insert,
	[battle.ExRecordEvent.sceneRoundExAttackData] = EventFuncMap.insert,
	...
	[battle.ExRecordEvent.skillAddBuffIds] = EventFuncMap.makeHash,
	[battle.ExRecordEvent.swapSpeedRefresh] = EventFuncMap.makeHash
}
local refreshFunc = {
	[battle.TimeIntervalType.wave] = {
		battle.ExRecordEvent.skillEffectLimit
	},
	[battle.TimeIntervalType.battleRound] = {
		battle.ExRecordEvent.attackState
	},
	[battle.TimeIntervalType.mainSkillEnd] = {
		battle.ExRecordEvent.replaceTarget
	}
}
...
function BattleExRecord:addExRecord(eventName, data, ...)
	...
	center = center or EventFuncMap.default
...
function BattleExRecord:refreshEventRecord(timeType)
	if not refreshFunc[timeType] then
		return
	end
