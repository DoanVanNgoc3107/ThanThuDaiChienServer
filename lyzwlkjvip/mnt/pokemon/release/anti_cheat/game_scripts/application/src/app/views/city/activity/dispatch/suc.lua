-- chunkname: @src.app.views.city.activity.dispatch.suc
...
function ActivityDispatchSuc:onCreate()
	local effect = widget.addAnimation(self:getResourceNode(), "qimiaomaoxian/weipaichenggong.skel", "effect", 0):scale(2.5):alignCenter(display.sizeInView)
