...
require("battle.models.play.experience_gate")
...
local map = {
	...
	[game.GATE_TYPE.dailyContract] = battlePlay.SimpleActivityGate,   --契约副本-奖励不展示

	[game.GATE_TYPE.friendFight] = battlePlay.FriendGate,		-- 好友切磋
	[game.GATE_TYPE.randomTower] = battlePlay.RandomGate,		-- 随机试炼塔-以太
	...
	[game.GATE_TYPE.experience] = battlePlay.ExperienceGate,  -- 试玩关卡
}
